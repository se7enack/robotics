...
: ${AMENT_CURRENT_PREFIX:="/workspaces/workspace1/ws1_pkg/install/ws1_pkg"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ws1_pkg/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ws1_pkg/environment/path.sh"
